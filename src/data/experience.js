export const experiences = [
  {
    ...
    location: "Remote",
    description:
      "Developing AI backend components for LLM-powered applications, focusing on prompt management, context handling, and response processing.",
    technologies: [
      "Python",
      "FastAPI",
      "LLMs",
  ...
  },
  {
    ...
    location: "Remote",
    description:
      "Developed foundational machine learning skills through practical work in Python, data analysis, supervised learning, and introductory LLM technologies.",
    technologies: [
      "Python",
      "NumPy",
      "Pandas",
    ...
    achievements: [
      "Implemented Python utility functions and strengthened programming fundamentals for machine learning workflows.",
      "Performed data preprocessing, filtering, grouping, and exploratory analysis using NumPy and Pandas on the ML dataset.",
