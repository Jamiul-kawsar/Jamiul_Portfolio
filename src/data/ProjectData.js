export const projectsData = [
  {
    ...
    description:
      "A modern real estate platform built with React, Vite, and Tailwind CSS that allows users to browse, explore, and visualize property listings in an intuitive UI. The project focuses on clean design, responsive layout, and smooth user experience, simulating a real-world property marketplace with structured components and scalable frontend architecture.",
    tags: ["React", "Vite", "Tailwind CSS", "Frontend", "UI/UX","Fully Responsive"],
    githubLink: "https://github.com/Jamiul-kawsar/Real_Estate",
    liveLink: "https://real-estate-jamiul.netlify.app/",
  },
  {
    id: 2,
    icon: "👨‍💼",
  ...
  },
  {
    id: 3,
    icon: "📰",
    title: "Prothom Alo News Portal Clone",
    description:
  ...
  },
  {
    id: 4,
    icon: "🔥",
    title: "Calories Burnt Prediction System",
    description:
      "A machine learning-based web application that predicts calories burned based on user input features. Built using XGBoost and deployed with Streamlit, the project demonstrates end-to-end ML workflow including data preprocessing, model training, evaluation, and deployment.",
    tags: ["Python", "Machine Learning", "XGBoost", "Streamlit", "NumPy", "Pandas"],
    githubLink: "https://github.com/Jamiul-kawsar/Calories_Burnt_Prediction",
    liveLink: "https://jamiul-kawsar-calories-burnt-predictor.streamlit.app/",
  },
  {
    id: 5,
    icon: "🎬",
  ...
  },
  {
    id: 6,
    icon: "🐍",
    title: "Two-Agent Snake Game (AI-Based)",
    description:
