  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gray-950 border-b border-gray-850 shadow-lg backdrop-blur-sm ">
      <div className="font-syne text-white flex items-center justify-between px-6 py-4">
        ...
        <button className="bg-gradient-to-l from-blue-500 to-violet-700 text-white font-bold py-2 px-4 rounded-md hover:from-blue-600 hover:to-violet-800 transition duration-300 ease-in-out cursor-pointer" >
          Hire Me
        </button>
      </div>
